...
public class RedistCopy {
	...
	public static void OnPostprocessBuild(BuildTarget target, string pathToBuiltProject) {
		...
		switch(target)
		{
			...
			{
				baseDir = System.IO.Path.Combine(System.IO.Path.GetDirectoryName(pathToBuiltProject), System.IO.Path.GetFileNameWithoutExtension(pathToBuiltProject) + "_Data");
			...
			{
				baseDir = System.IO.Path.Combine(System.IO.Path.Combine(System.IO.Path.GetDirectoryName(pathToBuiltProject), System.IO.Path.GetFileNameWithoutExtension(pathToBuiltProject) + ".app"), "Contents");
				break;
			}
		default:
			{
		...
		string pluginsDir = System.IO.Path.Combine(baseDir, "Plugins");
		...
		File.WriteAllLines(System.IO.Path.Combine(pluginsDir, "Steamworks.NET.txt"), DebugInfo);
	}
