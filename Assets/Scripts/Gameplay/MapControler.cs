...
public class MapControler : MonoBehaviour
{
   ...
   // [HideInInspector]
    ...
    {
        CanLoadBattle(); //Added by Seb. It would previously not check if it can load battle before, resulting in the bool not being set correctly. It is meant to run by update, but would not?

        if (SelectedIcon != null && canFight)
        {
