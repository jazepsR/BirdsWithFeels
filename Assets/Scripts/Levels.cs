...
public class Levels : MonoBehaviour {
	...
	public void  CheckBrave1()
	{
		if (myBird.lastLevel.emotion != Var.Em.Confident && (myBird.emotion == Var.Em.Confident || myBird.emotion == Var.Em.SuperConfident))
		{
			...
			{
				ApplyLevel(new LevelData(type.Brave2, Var.Em.Confident,Resources.Load<Sprite>("Icons/Brave1Icon")), "Brave 1");
			}
		}
	...
	public void CheckBrave2()
	{
		if (myBird.lastLevel.emotion != Var.Em.Confident && (myBird.emotion == Var.Em.Confident || myBird.emotion == Var.Em.SuperConfident))
		{
			...
			{
				ApplyLevel(new LevelData(type.Brave1, Var.Em.Confident, Resources.Load<Sprite>("Icons/Brave2Icon")), "Brave 2");
			}
		}
	}
